...
export default function StakingPage() {
 ...
 args: [staked], // staked est déjà un bigint ici
 });
 };
 ...
 className="px-8 py-4 bg-gradient-to-r from-cyan-500 to-pink-500 rounded-xl font-bold hover:scale-105 transition disabled:opacity-50 disabled:cursor-not-allowed"
 >
