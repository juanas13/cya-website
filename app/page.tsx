...
import { ArrowRight, Zap, Shield, Brain, TrendingUp, Lock, Users, Globe } from "lucide-react";
      ...
      <div className="min-h-screen bg-black text-white overflow-x-hidden">
        ...
        <section className="relative px-6 pt-24 pb-32 bg-gradient-to-b from-purple-900/30 via-black to-black">
          <div className="max-w-7xl mx-auto text-center">
            ...
            <p className="text-xl md:text-2xl mb-10 text-gray-300 max-w-4xl mx-auto leading-relaxed">
              ...
              Staking ultime • Rewards IA automatisés • Gouvernance décentralisée
            </p>
            ...
            <div className="grid grid-cols-3 gap-8 max-w-3xl mx-auto">
              ...
              <div className="text-center">
                ...
                <div className="text-gray-400 mt-2">Supply Max</div>
              </div>
              <div className="text-center">
        ...
        <section className="py-24 px-6 bg-gradient-to-b from-black to-gray-950">
          <div className="max-w-7xl mx-auto">
            <h2 className="text-5xl font-bold text-center mb-20">Pourquoi choisir CYA ?</h2>
            <div className="grid md:grid-cols-3 gap-10">
              <div className="bg-gray-900/50 border border-purple-800 rounded-2xl p-8 hover:border-purple-500 transition-all hover:transform hover:scale-105">
                <Brain className="w-14 h-14 text-purple-500 mb-6" />
                <h3 className="text-2xl font-bold mb-4">Rewards IA Automatisés</h3>
                <p className="text-gray-400 leading-relaxed">
                  Notre bot IA récompense automatiquement les utilisateurs actifs avec du CYA minté chaque mois (max 100 CYA/user).
                </p>
              </div>

              <div className="bg-gray-900/50 border border-purple-800 rounded-2xl p-8 hover:border-purple-500 transition-all hover:transform hover:scale-105">
                <Shield className="w-14 h-14 text-purple-500 mb-6" />
                <h3 className="text-2xl font-bold mb-4">Sécurité Maximale</h3>
                <p className="text-gray-400 leading-relaxed">
                  Proxy Upgradeable + Timelock + Ownership bientôt renoncé = Zéro risque de rug pull.
                </p>
              </div>

              <div className="bg-gray-900/50 border border-purple-800 rounded-2xl p-8 hover:border-purple-500 transition-all hover:transform hover:scale-105">
                <TrendingUp className="w-14 h-14 text-purple-500 mb-6" />
                <h3 className="text-2xl font-bold mb-4">Staking Intelligent</h3>
                <p className="text-gray-400 leading-relaxed">
                  Jusqu&apos;à 100% APY ajustable par la communauté + pénalité anti-dump de 7 jours.
                </p>
              </div>
            </div>
          </div>
        ...
        <section id="tokenomics" className="py-24 px-6 bg-black">
          <div className="max-w-7xl mx-auto">
            <h2 className="text-5xl font-bold text-center mb-20">Tokenomics 100% Transparents</h2>
            <div className="bg-gray-900/50 border border-purple-800 rounded-3xl p-12 max-w-5xl mx-auto">
              <div className="grid md:grid-cols-2 gap-12 mb-12">
                <div>
                  <h3 className="text-3xl font-bold mb-8 text-purple-400">Taxes sur transferts (2.5%)</h3>
                  <ul className="space-y-5 text-lg">
                    <li className="flex items-center gap-3"><span className="text-2xl">🔥</span> 0.5% Burn permanent</li>
                    <li className="flex items-center gap-3"><span className="text-2xl">💧</span> 1% Liquidité automatique</li>
                    <li className="flex items-center gap-3"><span className="text-2xl">🤖</span> 1% Rewards IA & Marketing</li>
                  </ul>
                </div>
                <div>
                  <h3 className="text-3xl font-bold mb-8 text-purple-400">Distribution & Supply</h3>
                  <ul className="space-y-5 text-lg">
                    <li>📊 Supply maximum : <strong>1 000 000 CYA</strong></li>
                    <li>🔒 Mint initial : 800k au Timelock</li>
                    <li>🤖 Rewards IA : max 1000 CYA/mois</li>
                    <li>⏳ Staking rewards : mint contrôlé par gouvernance</li>
                  </ul>
                </div>
              </div>
              <div className="text-center pt-8 border-t border-purple-800">
                <p className="text-xl text-purple-400 font-bold">
                  Contrat vérifié bientôt • Audit professionnel en cours
                </p>
              </div>
            </div>
          </div>
        ...
        {/* Final CTA */}
        <section className="py-24 px-6 bg-gradient-to-t from-purple-900/20 via-black to-black">
          <div className="max-w-4xl mx-auto text-center">
            <h2 className="text-5xl md:text-6xl font-bold mb-10">
              Rejoignez la révolution Crypto + IA
            </h2>
            <p className="text-xl text-gray-300 mb-10">
              Ne ratez pas le prochain token utilitaire qui récompense vraiment ses holders.
            </p>
            <a
              href="https://pancakeswap.finance/swap?outputCurrency=0x671cb1a2c934017fc019a7a4bf11ae5a30a32354&inputCurrency=BNB"
              target="_blank"
            ...
            <p className="mt-10 text-gray-400 font-mono">
        ...
        <footer className="py-12 border-t border-gray-800">
          <div className="max-w-7xl mx-auto text-center text-gray-500 px-6">
            ...
            <p className="mt-3 text-sm">Ce site n&apos;est pas un conseil financier. Faites vos propres recherches (DYOR).</p>
          </div>
        </footer>
      </div>
    </>
